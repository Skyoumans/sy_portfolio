...
Project.create({title: "Muscle Memory", desc: "The final project was created using React on Rails and CSS. I soon realized that this project quickly became the most complex of all my projects, and so I was determined to make it the best. It's still a work in progress.", img: "https://i.imgur.com/ELHfYR4m.png", link_at: "https://musclememory.herokuapp.com/"})
